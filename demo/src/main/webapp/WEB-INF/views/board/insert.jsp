		...
		<div style="width: 1000px; padding: 20px; border: 1px solid #cccccc">
			<form action="/board/insert" method="post" enctype="multipart/form-data">
				<div class="form-inline" style="margin: 5px;">
					...
					<input type="text" class="form-control" style="width: 600px;" name="brd_title" placeholder="제목 입력하세요." />
				</div>
				<div class="form-inline" style="margin: 5px;">
					<label style="width: 100px;">작성자</label> 
					<input type="text" class="form-control" style="width: 600px;" name="brd_id" value="${userid}" readonly/>
				</div>
				<div class="form-inline" style="margin: 5px;">
					<label style="width: 100px;">내용</label> 
					<textarea id="content" class="form-control" style="width: 600px;" name="brd_content" placeholder="내용을 입력하세요."></textarea>
				</div>
